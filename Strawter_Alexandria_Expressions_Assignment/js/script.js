...
//The user is prompted to enter 5 price values
...
var priceFive = prompt("Enter the price of your fifth item.");
/* For test values I entered 10,10,10,& 10*/
//place the items into an array to store the values
var items = [priceOne, priceTwo, priceThree, priceFour, priceFive];
